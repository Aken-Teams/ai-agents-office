...
const WEB_BASE = (config.line.publicApiBase || 'https://agents.theaken.com').replace(/\/$/, '');
...
export const DEFAULT_TILES: RichMenuTile[] = [
  ...
  },
  {
    id: 'upload',
    iconSvg:
      '<path d="M19.35 10.04A7.49 7.49 0 0 0 12 4c-2.62 0-4.88 1.42-6.1 3.5A5.97 5.97 0 0 0 0 13.5C0 16.54 2.46 19 5.5 19H19c2.21 0 4-1.79 4-4 0-2.05-1.55-3.75-3.5-3.96zM14 13v4h-4v-4H7l5-5 5 5h-3z"/>',
    label: '上傳檔案',
    caption: 'UPLOAD FILE',
    variant: 'medium',
    bounds: { x: 1250, y: 0, width: 750, height: 843 },
    action: { type: 'uri', uri: pageUrl('/import') },
  },
  {
    id: 'my_docs',
    iconSvg:
    ...
    action: { type: 'postback', data: 'action=list_files', displayText: '我的文件' },
  },
  {
    id: 'usage',
    iconSvg:
  ...
  },
  {
    ...
    action: { type: 'uri', uri: pageUrl('/guide') },
  },
];
