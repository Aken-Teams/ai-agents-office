...
// 強茂 ×10 → ×5 switch instant: 2026-07-03 16:00 Taipei. Mirrors the server's
// PRICING_X5_START. Compared against a record's absolute timestamp.
 ...
 * ×10 before the switch instant and ×5 after.
 */
