              ...
              return (
                ...
                >
                  ...
                  <div className="flex justify-between items-start">
                    <div
                      className="w-9 h-9 md:w-10 md:h-10 rounded flex items-center justify-center"
                      style={{ background: config.bgColor }}
                    >
                      <span className="material-symbols-outlined text-sm md:text-base" style={{ color: config.color }}>
                        {config.icon}
                      </span>
                    </div>
                    <div className="flex items-center gap-2">
